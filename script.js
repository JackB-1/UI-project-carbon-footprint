...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const groceries = [
        ...
        { name: 'Blueberries', origin: 'Finland', caloriesPer100g: 57, co2PerKg: 0.3 },
        { name: 'Carrot', origin: 'China', caloriesPer100g: 41, co2PerKg: 0.3 },
        { name: 'Cheese', origin: 'France', caloriesPer100g: 402, co2PerKg: 3.15 },
        { name: 'Herring', origin: 'Baltic Sea', caloriesPer100g: 158, co2PerKg: 1.7 },
        { name: 'Milk', origin: 'Finland', caloriesPer100g: 42, co2PerKg: 1.1 },
        { name: 'Oats', origin: 'Finland', caloriesPer100g: 389, co2PerKg: 0.4 },
        { name: 'Rye Bread', origin: 'Finland', caloriesPer100g: 259, co2PerKg: 0.4 },
        { name: 'Reindeer Meat', origin: 'Finland', caloriesPer100g: 173, co2PerKg: 1.2 },
    ...
    const countryCoordinates = {
     ...
     const groceryNameDisplay = document.querySelector('.table-bgcolor .row:nth-child(1) .col-3');
     const countryDisplay = document.querySelector('.table-bgcolor .row:nth-child(2) .col-3');
     const caloriesDisplay = document.querySelector('.table-bgcolor .row:nth-child(3) .col-3');
     const co2Display = document.querySelector('.table-bgcolor .row:nth-child(4) .col-3');
